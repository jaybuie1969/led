...
class Configuration(__BaseConfiguration__):
	'''
	This class defines a configuration object for modeling a scrolling window displaying Morse code for a string of programmagle LED lights
		...
		**kwargs : dict
		...
		if (self.configured):
			...
			if (len(self.errors) == 0):
				...
				self.argument_parser.add_argument("-s", "--signal", "--message", type=str, required=True, help="Text file that contains the message to be coverted to Morse code")
		...
		if (not self.configured):
			print(f"ERROR - This Morse Code project could not be configured.  The following error{'s' if (len(self.errors) != 1) else ''} occurred:")
			print("\n".join(self.errors))
